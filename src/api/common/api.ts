...
enum Api {
  ...
  roomList='/sg/sgRoom/list',
  berthList='/sg/sgBerth/list',
  sgPerson='/sg/sgPerson/list',
}
 ...
 */
 export const getRoomList = (params) => {
  return defHttp.get({ url: Api.roomList, params });
};
/**
 * 床位列表
 * @param params
 */
 export const getBerthList = (params) => {
  return defHttp.get({ url: Api.berthList, params });
};
/**
 * 人员列表
 * @param params
 */
 export const getPersonList = (params) => {
  return defHttp.get({ url: Api.sgPerson, params });
};
