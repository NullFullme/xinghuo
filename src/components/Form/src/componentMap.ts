...
//业务自定义组件
import JSelectRoom from './jeecg/components/JSelectRoom.vue';
import JSelectBerth from './jeecg/components/JSelectBerth.vue';
import JSelectPerson from './jeecg/components/JSelectPerson.vue';
...
//注册业务自定义组件
componentMap.set('JSelectRoom', JSelectRoom);
componentMap.set('JSelectBerth', JSelectBerth);
componentMap.set('JSelectPerson', JSelectPerson);
