...
<template>
  <div>
    ...
    <RoomSelectModal :rowKey="rowKey" @register="regModal" @getSelectResult="setValue" v-bind="getBindValue"></RoomSelectModal>
  </div>
</template>
<script lang="ts">
  import { unref } from 'vue';
  import RoomSelectModal from './modal/RoomSelectModal.vue';
