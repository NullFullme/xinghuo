...
<template>
  <div>
    ...
    <PersonSelectModal :rowKey="rowKey" @register="regModal" @getSelectResult="setValue" v-bind="getBindValue"></PersonSelectModal>
  </div>
</template>
<script lang="ts">
  import { unref } from 'vue';
  import PersonSelectModal from './modal/PersonSelectModal.vue';
