...
<template>
  <div>
    ...
    <BerthSelectModal :rowKey="rowKey" @register="regModal" @getSelectResult="setValue" v-bind="getBindValue"></BerthSelectModal>
  </div>
</template>
<script lang="ts">
  import { unref } from 'vue';
  import BerthSelectModal from './modal/BerthSelectModal.vue';
