...
<template>
  <div>
    <BasicModal v-bind="$attrs" @register="register" :title="modalTitle" width="1000px" wrapClassName="j-Berth-select-modal" @ok="handleOk" destroyOnClose @visible-change="visibleChange">
      <a-row>
...
<script lang="ts">
  ...
  import { getBerthList } from '/@/api/common/api';
  ...
  export default defineComponent({
    ...
    setup(props, { emit, refs }) {
      ...
      const [{ rowSelection, visibleChange, selectValues, indexColumnProps, getSelectResult, handleDeleteSelected, selectRows }] = useSelectBiz(getBerthList, getBindValue);
