...
<script lang="ts">
  ...
  import { getRoomList } from '/@/api/common/api';
  ...
  export default defineComponent({
    ...
    setup(props, { emit, refs }) {
      ...
      const [{ rowSelection, visibleChange, selectValues, indexColumnProps, getSelectResult, handleDeleteSelected, selectRows }] = useSelectBiz(getRoomList, getBindValue);
