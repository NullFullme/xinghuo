...
<template>
  <div>
    <BasicModal v-bind="$attrs" @register="register" :title="modalTitle" width="1000px" wrapClassName="j-room-select-modal" @ok="handleOk" destroyOnClose @visible-change="visibleChange">
      <a-row>
...
<script lang="ts">
  ...
  import { getPersonList } from '/@/api/common/api';
  ...
  export default defineComponent({
    ...
    setup(props, { emit, refs }) {
      ...
      const [{ rowSelection, visibleChange, selectValues, indexColumnProps, getSelectResult, handleDeleteSelected, selectRows }] = useSelectBiz(getPersonList, getBindValue);
